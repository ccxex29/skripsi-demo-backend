"""
Our InceptionV3 Cherrypicked Model Module
"""
...
class InceptionV3Cherry(Model):
    """
    InceptionV3 Cherrypicked Model
    """
    def _load_model(self): # pylint: disable=R0201,C0116
        return keras.models.load_model('models/preprocessed/inception_cherry')
